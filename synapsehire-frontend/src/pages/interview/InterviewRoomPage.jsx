  ...
  return (
    <main className="flex min-h-screen flex-col bg-panel text-ink">
      <header className="flex flex-wrap items-center justify-between gap-3 border-b border-slate-200 bg-ink px-5 py-4 text-white">
        <div>
          <p className="text-xs font-semibold uppercase tracking-[0.14em] text-white/60">Coding assignment</p>
          <h1 className="mt-1 text-xl font-semibold">Assignment workspace</h1>
        </div>
          ...
          <div className="mx-auto grid max-w-7xl gap-4 lg:grid-cols-[1fr_380px]">
            <div>
              <div className="mb-3 flex flex-wrap items-center justify-between gap-3">
                <div>
                  <p className="text-xs font-semibold uppercase tracking-[0.14em] text-brand">Assignment problem</p>
